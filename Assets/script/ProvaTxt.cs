...
public class ProvaTxt : MonoBehaviour
{
    ...
    private const int maxframe_count = 120 * 5;                  // Maximum number of samples for eye tracking (120 Hz * time in seconds).
    ...
    void Measurement()
    {
        ...
        {
            Debug.Log("Register Eye Tracking Callback");
        ...
        {
            Debug.Log("Unregister Eye Tracking Callback");
