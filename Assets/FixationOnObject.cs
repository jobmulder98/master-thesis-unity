...
public class FixationOnObject : MonoBehaviour, IGazeFocusable
{
    ...
    private int userID = GazeDataReceiver.userID;
    private string condition = GazeDataReceiver.condition;
    private string dataDirectory = GazeDataReceiver.dataDirectory;
